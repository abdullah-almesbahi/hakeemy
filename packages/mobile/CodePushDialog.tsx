...
interface CodePushDialogProps {
  onGetCurrentPackageInfo: (version: any, packageInfo: any) => void;
  titleStates: any;
  optionTexts: any;
  downloadStatus: any;
  ...
  storeAppID: '';
  isCheckOnResume: any;
  onDidCheckUpdate: any;
  onGetStoreInfo: any;
  storeAppName: any;
  storeIgnoreErrors: any;
  deploymentKey: string;
  onGetRemotePackageInfo: any;
  updateLaterButtonStyle: any;
  updateLaterButtonText: string;
  updateLaterButtonTextStyle: any;
  updateNowButtonStyle: any;
  updateNowButtonText: string;
  updateNowButtonTextStyle: any;
  restartLaterButtonStyle: any;
  restartLaterButtonText: string;
  restartLaterButtonTextStyle: any;
  restartNowButtonStyle: any;
  restartNowButtonText: string;
  restartNowButtonTextStyle: any;
  progressBarContainerStyle: any;
  progressBarStyle: any;
  progressTextStyle: any;
  progressStatusStyle: any;
  progressBarColor: any;
  progressBarThickness: any;
  headerContainerStyle: any;
  imageHeaderSource: any;
  imageHeaderStyle: any;
  imageHeaderContainerStyle: any;
  titleStyle: any;
  versionTextStyle: any;
  versionTextContainerStyle: any;
  descriptionTitleStyle: any;
  confirmTextStyle: any;
  descriptionTitle: any;
  isHiddenDescription: any;
    ...
    if (allowStoreCheck && appID !== '') {
      ...
      VersionCheck.needUpdate()
        ...
        .then(canOpen => {
          if (!canOpen)
            throw Error(
              "Can't open store url, will fallback to check code push"
            );
          console.log('*** need update store: ', storeUrl);
          this.setState(
            { storeUrl, state: 'NeedStoreUpdate', showContent: true },
            this._show
          );
        })
        .catch(error => {
  ...
  _renderBody = () => {
    ...
    if (state === 'Updated') {
      return (
        <View style={styles.contentContainer}>
          <Text style={[styles.descriptionTitle, descriptionTitleStyle]}>
            {this._getTextFromState('UpdatedText')}
          </Text>
          <Text style={[styles.confirmRestartText, confirmTextStyle]}>
            {isMandatory
    ...
    return (
      <View style={styles.contentContainer}>
        <Text style={[styles.descriptionTitle, descriptionTitleStyle]}>
          {this._getTextFromState('UpdateText')}
        </Text>
